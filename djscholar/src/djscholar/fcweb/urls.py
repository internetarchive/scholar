...
urlpatterns = [
    ...
    # -- Editgroup entity views (410 Gone) ------------------------------------
    path("editgroup/<str:editgroup_id>/container/<str:ident>",
         views.editgroup_view, name="container_editgroup_view"),
    path("editgroup/<str:editgroup_id>/container/<str:ident>/metadata",
         views.editgroup_view, name="container_editgroup_view_metadata"),
    path("editgroup/<str:editgroup_id>/creator/<str:ident>",
         views.editgroup_view, name="creator_editgroup_view"),
    path("editgroup/<str:editgroup_id>/creator/<str:ident>/metadata",
         views.editgroup_view, name="creator_editgroup_view_metadata"),
    path("editgroup/<str:editgroup_id>/file/<str:ident>",
         views.editgroup_view, name="file_editgroup_view"),
    path("editgroup/<str:editgroup_id>/file/<str:ident>/metadata",
         views.editgroup_view, name="file_editgroup_view_metadata"),
    path("editgroup/<str:editgroup_id>/fileset/<str:ident>",
         views.editgroup_view, name="fileset_editgroup_view"),
    path("editgroup/<str:editgroup_id>/fileset/<str:ident>/metadata",
         views.editgroup_view, name="fileset_editgroup_view_metadata"),
    path("editgroup/<str:editgroup_id>/webcapture/<str:ident>",
         views.editgroup_view, name="webcapture_editgroup_view"),
    path("editgroup/<str:editgroup_id>/webcapture/<str:ident>/metadata",
         views.editgroup_view, name="webcapture_editgroup_view_metadata"),
    path("editgroup/<str:editgroup_id>/release/<str:ident>",
         views.editgroup_view, name="release_editgroup_view"),
    path("editgroup/<str:editgroup_id>/release/<str:ident>/metadata",
         views.editgroup_view, name="release_editgroup_view_metadata"),
    path("editgroup/<str:editgroup_id>/release/<str:ident>/contribs",
         views.editgroup_view, name="release_editgroup_view_contribs"),
    path("editgroup/<str:editgroup_id>/release/<str:ident>/references",
         views.editgroup_view, name="release_editgroup_view_references"),
    path("editgroup/<str:editgroup_id>/work/<str:ident>",
         views.editgroup_view, name="work_editgroup_view"),
    path("editgroup/<str:editgroup_id>/work/<str:ident>/metadata",
         views.editgroup_view, name="work_editgroup_view_metadata"),

    # -- Editgroup / editor views (410 Gone) ----------------------------------
    path("editgroup/<str:ident>/diff", views.editgroup_view, name="editgroup_diff_view"),
    path("editgroup/<str:ident>", views.editgroup_view, name="editgroup_detail_view"),
    path("editor/<str:ident>/editgroups", views.editor_view, name="editor_editgroups"),
    path("editor/<str:ident>/annotations", views.editor_view, name="editor_annotations"),
    path("editor/<str:ident>", views.editor_view, name="editor_detail_view"),
    path("u/<str:username>", views.editor_view, name="editor_username_redirect"),
    ...
    path("webcapture/rev/<str:rev_id>/metadata", views.webcapture_revision_view,
         name="webcapture_revision_view_metadata"),
    path("release/rev/<str:rev_id>", views.release_revision_view,
         name="release_revision_view"),
    path("release/rev/<str:rev_id>/metadata", views.release_revision_view,
         name="release_revision_view_metadata"),
    path("release/rev/<str:rev_id>/contribs", views.release_revision_view,
         name="release_revision_view_contribs"),
    path("release/rev/<str:rev_id>/references", views.release_revision_view,
         name="release_revision_view_references"),
    path("work/rev/<str:rev_id>", views.work_revision_view,
         name="work_revision_view"),
    path("work/rev/<str:rev_id>/metadata", views.work_revision_view,
         name="work_revision_view_metadata"),

    # -- Entity history (410 Gone) --------------------------------------------
    path("container/<str:ident>/history", views.entity_history_view, name="container_history"),
    path("creator/<str:ident>/history", views.entity_history_view, name="creator_history"),
    path("file/<str:ident>/history", views.entity_history_view, name="file_history"),
    path("fileset/<str:ident>/history", views.entity_history_view, name="fileset_history"),
    path("webcapture/<str:ident>/history", views.entity_history_view, name="webcapture_history"),
    path("release/<str:ident>/history", views.entity_history_view, name="release_history"),
    path("work/<str:ident>/history", views.entity_history_view, name="work_history"),
